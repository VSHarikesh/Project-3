...
class Hari:
    ...
    # Tax_Exemptions_locator as XPATH
    Tax_Exemptions_locator = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[8]/a'
    ...
    # Method for Tax exemptions page
    def Tax_Exemptions(self):
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.Tax_Exemptions_locator).click()
        #Bug removal
        while(True):
            pass
