...
class Hari:
    ...
    def Salary(self):
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.Salary_locator).click()
        self.driver.find_element(by=By.XPATH, value=self.ADDbutton_locator).click()
