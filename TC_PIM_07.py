...
class Hari:
    ...
    # Emergencu contacts locator as XPATH
    EmergencyContacts_locator = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[3]/a'
    # Add button locator as 
    Add_Button_locator = 'button.oxd-button.oxd-button--medium.oxd-button--text'
    ...
    # Method for Emergency contacts page
    def Emergency_contacts(self):
        sleep(4)
        self.driver.find_element(by=By.XPATH, value=self.EmergencyContacts_locator).click()
        self.driver.find_element(by=By.CSS_SELECTOR, value=self.Add_Button_locator).click()
        #Bug removal
        while(True):
            pass
